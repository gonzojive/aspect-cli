...
require (
	...
	github.com/bazelbuild/bazel-gazelle v0.39.1 // NOTE: keep in sync with fetch.bzl
	github.com/bazelbuild/bazelisk v1.22.0
...
require (
	github.com/bazelbuild/rules_python/gazelle v0.0.0-20241003043026-9c3d303418a4
	github.com/charmbracelet/huh v0.6.0
	github.com/hay-kot/scaffold v0.4.1
